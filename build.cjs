...
fs.writeFileSync('company-public-runtime.js','globalThis.MasalCompanyVueSource='+JSON.stringify(fs.readFileSync('assets/vue.global.prod.js','utf8'))+';');
